                        ...
                        <form method="POST" id="form1" action="{{ route('customer.individual.update', [$customer->id]) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('industry') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="industry" id="input-industry" class="form-control form-control-alternative{{ $errors->has('industry') ? ' is-invalid' : '' }}" placeholder="{{ __('Industry') }}" value="{{ $customer->individual->industry }}" required>

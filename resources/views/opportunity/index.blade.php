                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('All Opportunities') }}</h3>
                            </div>
                    ...
                    <!-- <div class="col-xl-6">
                        <div class="form-group{{ $errors->has('contact') ? ' has-danger' : '' }}">
                            ...
                            <select name="getOpportunity" id="account" class="form-control form-control-alternative{{ $errors->has('contact') ? ' is-invalid' : '' }}" placeholder="{{ __('Contact') }}" value="{{ old('contact') }}">
                                <option value="1">View all Opportunities</option>
                                <option value="1">Select Contact</option>
                                <option value="2">Select Contact</option>

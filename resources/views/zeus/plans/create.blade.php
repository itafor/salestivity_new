            ...
            <div class="col">
                <div class="card shadow">
                    ...
                    <div class="col-12">
                     ...
                     <form method="post" action="{{ route('admin.plans.store') }}" autocomplete="off">
                        @csrf
                        <div class="pl-lg-4">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="form-group{{ $errors->has('number_of_subusers') ? ' has-danger' : '' }} col-6">
                                    ...
                                    <input type="number" name="number_of_subusers"
                                           ...
                                           placeholder="Number of  Sub Users" value="{{old('number_of_subusers')}}" required>
                                ...
                                <div class="form-group{{ $errors->has('number_of_accounts') ? ' has-danger' : '' }} col-6">
                                    ...
                                    <input type="text" name="number_of_accounts"
                                           ...
                                           placeholder="Number of Accounts" value="{{old('number_of_accounts')}}" required>

        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <h3 class="heading-small text-muted mb-4">Manage Invoice</h3>

                        <form action="{{ route('billing.invoice.pay') }}" method="post">
                            @csrf
                            <input type="hidden" name="customer_id" value="{{ $invoice->customers->id }}">

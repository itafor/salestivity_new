                ...
                <div class="card shadow">
                    <div class="card-header bg-white">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Manage Order') }}</h3>
                            </div>
...
<label class="form-control-label" for="product_id">{{ __('Product') }}</label>
    ...
    <input type="number" min="1" name="quantity" id="quantity" class="form-control form-control-alternative{{ $errors->has('quantity') ? ' is-invalid' : '' }}" placeholder="{{ __('Product Quantity') }}" value="{{$order->quantity}}">

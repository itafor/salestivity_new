                        ...
                        <form method="post" action="{{ route('project.update', $project->id) }}" id="form1" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('customer_account') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="customer_account" id="customer_account" class="form-control form-control-alternative{{ $errors->has('customer_account') ? ' is-invalid' : '' }}" placeholder="{{ __('Account') }}" value="{{ $project->customer_account }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('technician') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="technician" id="technician" class="form-control form-control-alternative{{ $errors->has('technician') ? ' is-invalid' : '' }}" placeholder="{{ __('Technician') }}" value="{{ $project->technician }}" required>
                                ...
                                <div class="form-group{{ $errors->has('start') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="date" name="start" id="start" class="form-control form-control-alternative{{ $errors->has('start') ? ' is-invalid' : '' }}" placeholder="{{ __('Start date') }}" value="{{ $project->start_date }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('notes') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="textarea" name="notes" id="notes" class="form-control form-control-alternative{{ $errors->has('notes') ? ' is-invalid' : '' }}" placeholder="{{ __('Notes') }}" value="{{ $project->notes }}" required >
